<template>
  <section
    class="inventory-section sidebar container mx-auto mb-16 items-start"
      ...
      >
        ...
        >
          <transition name="fade-slide" mode="out-in">
            ...
            <div
              v-else
              class="back-side relative flex flex-col justify-between h-full max-w-screen-md mx-auto p-2"
            >
              ...
              <div class="p-4 pb-0 flex items-center space-x-4">
                ...
                />
                <h4 class="font-semibold text-xl text-gray-800 w-2/3">
                  {{ art.title }}
                </h4>
                <button
                  @click="toggleItem(art.id)"
                  class="absolute right-6 top-6 bg-gray-100 hover:bg-gray-200 p-1 rounded-full px-2.5 transition-colors duration-300 shadow-sm"
                >
