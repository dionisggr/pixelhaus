  ...
  <form @submit.prevent="updateProfile">
    <div class="flex flex-wrap -mx-2">
      <div class="mb-4 px-2 w-full md:w-1/2">
        <!-- Bind to formData.firstName instead of user.firstName -->
        <input v-model="formData.firstName" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="firstName" type="text" placeholder="First Name" />
      </div>
      <div class="mb-4 px-2 w-full md:w-1/2">
        <!-- Bind to formData.lastName instead of user.lastName -->
        <input v-model="formData.lastName" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="lastName" type="text" placeholder="Last Name" />
      </div>
    </div>
    <div class="flex flex-wrap -mx-2">
      <div class="mb-4 px-2 w-full md:w-1/2">
        <!-- Bind to formData.email instead of user.email -->
        <input v-model="formData.email" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="email" type="email" placeholder="Email" />
      </div>
      <div class="mb-4 px-2 w-full md:w-1/2 flex justify-center items-center">
        <button @click="showChangePasswordModal = true" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
          Change Password
        </button>
      </div>
    </div>
    <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold mx-auto py-2 px-4 rounded block mt-6 focus:outline-none focus:shadow-outline">
      Save Changes
    </button>
  </form>
</div>
...
<div class="bg-white shadow rounded-lg p-6">
  ...
  <div class="flex flex-wrap justify-start">
    <div v-for="card in paymentMethods" :key="card.id" class="p-2 w-full md:w-1/3">
      <div
...
export default {
  ...
  methods: {
    ...
    removeCard(cardId) {
      ...
      // Remove the card from the paymentMethods array
    ...
    deleteAccount() {
      ...
      this.$emit('logout');
      alert('Account deleted.'); // Replace this with your delete logic
